...
const SESSION_ID = process.env.SESSION_ID || "2700ae450ca123598f12e61de3ffc";
const SUDO = process.env.SUDO || '263780882809';
...
const BOT_INFO = process.env.BOT_INFO || "NgodzaTech-Bot;ASWIN SPARKY;https://i.imgur.com/r3GZeiX.jpeg";
